    ...
    public static void registerEvents() {
        ...
        ClientPlayConnectionEvents.JOIN.register((handler, sender, client) -> {
            ...
            if(saveFile.isFile() && saveFile.exists()) {
                ...
                if (deserialized != null) {
                    GlowingEyesComponent.load(client.player, handler.registryAccess(), deserialized);
                } else {
        ...
        ClientPlayConnectionEvents.DISCONNECT.register((handler, client) -> {
            ...
            if(!ClientPlayerDataComponent.isModOnServer()) {
                CompoundTag serialized = GlowingEyesComponent.serialize(client.player, handler.registryAccess());
