...
public enum SlimSkinPart implements ISkinPart {
    ...
    RIGHT_ARM_OVERLAY_TOP(4, true, 3, 4),
    RIGHT_ARM_OVERLAY_BOTTOM(4, true, 3, 4),
    ...
    RIGHT_ARM_OVERLAY_FRONT(5, true, 3, 12),
    RIGHT_ARM_OVERLAY_LEFT(5, true, 4, 12),
    RIGHT_ARM_OVERLAY_BACK(5, true, 3, 12),
    ...
    public int getX() {
        if (this.x == -1) {
            this.x = 0;
            for (SlimSkinPart part : getRow(this.row)) {
                if (part == this) break;
